...
KEYWORDS = [
    ...
    Keyword(name="C#", linkedin_value="C#", nerdin_value="CodigoPlataforma=26&", thor_value="/jobs-c-sharp",
            alias_list=["CSharp"]),
    Keyword(name="C++", linkedin_value="C++", nerdin_value="CodigoPlataforma=85&", thor_value="/jobs-c++",
    ...
    Keyword(name="VueJs", linkedin_value="Vue", nerdin_value="CodigoPlataforma=130&", thor_value="/jobs-vue-js", ),
